...
const Paper = ({ navigation, route }) => {
    ...
    useEffect(() => {
        const Listener = fetch(`http://theadmissionmantra.in/papers.php?tno=${thread}`)
        ...
        const anotherlistener = fetch(`http://theadmissionmantra.in/marquee.php`)
            .then((response) => response.json())
            .then((responseJson) => {
